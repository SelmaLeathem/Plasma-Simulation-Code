 ...
 * discharge over a 1000 RF cycles.
 * 
 * The simulation takes approximately 5 hours to run on a computer with 4GB RAM,
...
//Used for secondary electrons and collisions 
